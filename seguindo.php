...
<div class="sidebar">
  ...
  <nav>
    ...
    <a href="seguindo.php" class="ativo">Seguindo</a>
...
<div class="main">
<h2>Você está seguindo</h2>
<?php
if($result->num_rows == 0){
    echo "<p style='text-align:center;'>Você ainda não segue ninguém.</p>";
} else {
    ...
    echo "<form method='post' action='deixar_de_seguir.php' style='margin:0;'>
            ...
            <button type='submit' style='padding:6px 12px; border:none; border-radius:8px; background:#ff4da6; color:white; cursor:pointer;'>Deixar de seguir</button>
          </form>";
